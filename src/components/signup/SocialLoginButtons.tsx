...
export const SocialLoginButtons: React.FC = () => {
  ...
  return (
    <div className="flex w-full gap-4 text-white font-medium flex-wrap max-md:max-w-full">
      <button
        onClick={handleGoogleLogin}
        className="border flex min-w-60 items-center gap-[2vw] justify-center flex-1 p-[24px] rounded-xl border-[rgba(255,255,255,0.2)] border-solid hover:bg-[rgba(255,255,255,0.05)] transition-colors"
        type="button"
      >
        <svg
          width="24"
      ...
      <button
        ...
        className="border flex min-w-60 items-center gap-[2vw] flex-1 justify-center p-[24px] rounded-xl border-[rgba(255,255,255,0.2)] border-solid hover:bg-[rgba(255,255,255,0.05)] transition-colors"
        type="button"
      >
        <svg
        width="13"
