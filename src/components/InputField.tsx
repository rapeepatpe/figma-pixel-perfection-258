  ...
  return (
    <div className="flex flex-col items-start gap-2 self-stretch">
      <div className="flex justify-between items-start self-stretch">
        <label className="flex-1 text-[#9794AA] text-base font-normal leading-[25px] max-sm:text-sm">
          {label}{required && '*'}
        </label>
        {showPasswordToggle && (
          <div className="flex w-[73px] justify-between items-center">
            <button
              type="button"
      ...
      <div className="flex justify-between items-center self-stretch border px-5 py-[15.5px] rounded-md border-solid border-[#9794AA] max-sm:px-4 max-sm:py-3">
        <input
          type={inputType}
          value={value}
          maxLength={maxLength}
